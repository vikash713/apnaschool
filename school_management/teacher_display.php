...
<body>
    <div class="container">
        <h2><mark>DISPLAYING TEACHER RECORD</mark></h2>
        <table border="3" cellspacing="7">
            ...
            if (isset($_POST['Add'])) {
                ...
                if ($fname != "" && $lname != "" && $password != "" && $conpassword != "" && $gender != "" && $email != "" && $phone != "" && $address != "") {
                    $query = "INSERT INTO teacher (fname, lname, password, cpassword, gender, email, phone, address) VALUES ('$fname', '$lname', '$password', '$conpassword', '$gender', '$email', '$phone', '$address')";
            ...
            if ($total != 0) {
                while ($result = mysqli_fetch_assoc($data)) {
                    echo "<tr>
                        ...
                        <td class='operations'>
                            <a href='teacherupdate_detail.php?result=" . urlencode(json_encode($result)) . "'>Update</a>
                        </td>
                        <td class='operations'>
                            <a href='teacheradd_detail.php'>Add</a>
                        </td>
                        <td class='operations'>
